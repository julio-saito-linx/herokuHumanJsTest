...
exports["body"] = function tmpl_body(locals) {
    var buf = [];
    buf.push('<body><div class="container"><div class="navbar"><div class="navbar-inner"><a href="#" class="brand">herokuHumanJsTest</a><ul class="nav"><li><a href="/">home</a></li><li><a href="/collections">collection demo</a></li><li><a href="/info">more info</a></li></ul></div></div><main id="pages"></main></div></body>');
    return buf.join('');
};
